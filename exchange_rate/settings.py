...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'user': os.getenv('rate_limit')
    }
}

FIXER_URL = os.getenv('FIXER_URL')
FIXER_API_KEY = os.getenv('FIXER_API_KEY')
FIXER_BASE = os.getenv('FIXER_BASE')

BANXICO_TOKEN = os.getenv('BANXICO_TOKEN')
BANXICO_URL = os.getenv('BANXICO_URL')
BANXICO_SERIE = os.getenv('BANXICO_SERIE')

DIARIO_OFICIAL_URL = os.getenv('DIARIO_OFICIAL_URL')
DIARIO_OFICIAL_TABLE_POSITION = int(os.getenv('DIARIO_OFICIAL_TABLE_POSITION'))
